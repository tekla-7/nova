...
export default function ApplePay() {
    ...
    return <div className='bg-[#fcfcfb] border border-[#0b0b0b]/10 rounded-[10] p-5 text-center mt-2.5'>
        ...
        <button onClick={applePaySession} className="w-full cursor-pointer inline-flex items-center justify-center gap-1 bg-black hover:bg-neutral-800 text-white font-medium text-sm py-1.5 px-3 rounded transition-colors duration-200">
