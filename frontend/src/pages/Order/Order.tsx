        ...
        <div className='grid grid-cols-[1fr_0.7fr] min-h-[70vh]'>
            <div className='p-5 border-r border-r-[#E5E0D8]'>
                ...
                {order.tracking.delivered.isConfirmed && <span
                    className='px-3 gap-1 text-[#006300] bg-[#caeac7] rounded-[20px] font-medium py-1 text-xs flex items-center '>
<Check size={12}/> Delivered
                </span>}
                {!order.tracking.delivered.isConfirmed && <span
                    className='px-3 gap-1 text-[#898781] border border-[#0b0b0b]/20 bg-transparent rounded-[20px] font-medium py-1 text-xs flex items-center '>
    <Ellipsis size={12}/>
 In Progress
                </span>}
